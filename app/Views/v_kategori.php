    ...
    <tbody>
        <?php foreach ($product_category as $index => $kategori) : ?>
            <tr>
                ...
                <td><?php echo esc($kategori['category']) ?></td>
                <td>
                        ...
                        <form action="<?= base_url('kategori/edit/' . $kategori['id']) ?>" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="category" class="form-control" id="category" placeholder="Deskripsi Kategori" required><?= esc($kategori['category']) ?></textarea>
                                </div>
                            </div>
            ...
            <form action="<?= base_url('kategori') ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="category" class="form-control" id="category" placeholder="Deskripsi Kategori" required></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
