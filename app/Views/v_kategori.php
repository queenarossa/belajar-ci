    ...
    <tbody>
        <?php foreach ($product_category as $index => $kategori) : ?>
            <tr>
                ...
                <td><?php echo esc($kategori['category_name']) ?></td>
                        ...
                        <form action="<?= base_url('kategori/edit/' . $kategori['id']) ?>" method="post">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_name" class="form-control" id="category_name" value="<?= esc($kategori['category_name']) ?>" placeholder="Nama Kategori" required>
                                </div>
                                <div class="form-group">
